...
class RPCExtLegacyMixin(Protocol):
	...
	def getOpsiInformation_hash(self: BackendProtocol) -> dict:
		return self.backend_info()

	@rpc_method(deprecated=True, alternative_method="dispatcher_getConfig", check_acl=False)
	def getBackendInfos_listOfHashes(self: BackendProtocol) -> list[dict]:
		return [{}]

	@rpc_method(deprecated=True, alternative_method="backend_getInterface", check_acl=False)
	def getPossibleMethods_listOfHashes(self: BackendProtocol) -> list[dict]:
		possible_methods = []
	...
	@rpc_method(deprecated=True, alternative_method="configState_getObjects", check_acl=False)
	def getGeneralConfigValue(self: BackendProtocol, key: str, objectId: str | None = None) -> str:
	...
	def getNetworkConfig_hash(self: BackendProtocol, objectId: str | None = None) -> dict[str, str]:
	...
	@rpc_method(deprecated=True, check_acl=False)
	def getNetworkConfigValue(self: BackendProtocol, key: str, objectId: str | None = None) -> str:
	...
	def getGroupIds_list(self: BackendProtocol) -> list[str]:
		return self.group_getIdents(returnType="unicode")

	@rpc_method(deprecated=True, check_acl=False)
	def getHostGroupTree_hash(self: BackendProtocol) -> dict:
	...
	def getSoftwareInformation_hash(self: BackendProtocol, hostId: str) -> dict:
	...
	@rpc_method(deprecated=True, alternative_method="auditSoftwareOnClient_getObjects", check_acl=False)
	def getSoftwareInformation_listOfHashes(self: BackendProtocol) -> list[dict]:
		result = []
	...
	def getOpsiHWAuditConf(self: BackendProtocol, locale: str | None = None) -> list:
	...
	@rpc_method(deprecated=True, alternative_method="host_getIdents", check_acl=False)
	def getServerIds_list(self: BackendProtocol) -> list[str]:
		return self.host_getIdents(type="OpsiConfigserver")

	@rpc_method(deprecated=True, alternative_method="host_getIdents", check_acl=False)
	def getServerId(self: BackendProtocol, clientId: str) -> str:
	...
	@rpc_method(deprecated=True, alternative_method="host_getIdents", check_acl=False)
	def getDepotIds_list(self: BackendProtocol) -> list[str]:
	...
	@rpc_method(deprecated=True, alternative_method="host_getObject", check_acl=False)
	def getMacAddress(self: BackendProtocol, hostId: str) -> str:
		return self.getMacAddresses_list(hostId)[0]

	@rpc_method(deprecated=True, alternative_method="host_updateObject", check_acl=False)
	def setMacAddress(self: BackendProtocol, hostId: str, mac: str) -> None:
	...
	def lockProduct(self: BackendProtocol, productId: str, depotIds: list[str] | None = None) -> None:
	...
	@rpc_method(deprecated=True, alternative_method="productOnDepot_updateObjects", check_acl=False)
	def unlockProduct(self: BackendProtocol, productId: str, depotIds: list[str] | None = None) -> None:
		depotIds = depotIds or []
		product_on_depots = self.productOnDepot_getObjects(productId=productId, depotId=depotIds)
		if not product_on_depots:
			raise BackendMissingDataError(f"Product {productId!r} not found on given depots")
	...
	@rpc_method(deprecated=True, alternative_method="product_getObjects", check_acl=False)
	def getProducts_listOfHashes(self: BackendProtocol, depotId: str | None = None) -> list[dict[str, Any]]:
		if not depotId:
	...
	def getInstallableProductIds_list(self: BackendProtocol, clientId: str) -> list[str]:
	...
	@rpc_method(deprecated=True, alternative_method="productOnDepot_getIdents", check_acl=False)
	def getInstallableLocalBootProductIds_list(self: BackendProtocol, clientId: str) -> list[str]:
		depot_id = self.getDepotId(clientId=clientId)
		return [
	...
	@rpc_method(deprecated=True, alternative_method="productOnDepot_getIdents", check_acl=False)
	def getInstallableNetBootProductIds_list(self: BackendProtocol, clientId: str) -> list[str]:
		depot_id = self.getDepotId(clientId=clientId)
		return [
	...
	def getInstalledProductIds_list(self: BackendProtocol, objectId: str) -> list[str]:
		return [
	...
	@rpc_method(deprecated=True, alternative_method="productOnClient_getIdents", check_acl=False)
	def getInstalledLocalBootProductIds_list(self: BackendProtocol, objectId: str) -> list[str]:
		return [
			productOnClient.productId
			for productOnClient in self.productOnClient_getObjects(
	...
	@rpc_method(deprecated=True, alternative_method="productOnClient_getIdents", check_acl=False)
	def getInstalledNetBootProductIds_list(self: BackendProtocol, objectId: str) -> list[str]:
		return [
			productOnClient.productId
			for productOnClient in self.productOnClient_getObjects(
	...
	@rpc_method(deprecated=True, alternative_method="productOnClient_getIdents", check_acl=False)
	def getProvidedLocalBootProductIds_list(self: BackendProtocol, depotId: str) -> list[str]:
		return [
	...
	@rpc_method(deprecated=True, alternative_method="productOnDepot_getIdents", check_acl=False)
	def getProvidedNetBootProductIds_list(self: BackendProtocol, depotId: str) -> list[str]:
		return [
	...
	@rpc_method(deprecated=True, alternative_method="product_getObjects", check_acl=False)
	def getPossibleProductActions_hash(self: BackendProtocol, depotId: str | None = None) -> dict:
		result = {}
	...
	@rpc_method(deprecated=True, alternative_method="productOnClient_updateObjects", check_acl=False)
	def unsetProductActionRequest(self: BackendProtocol, productId: str, clientId: str) -> None:
		self.setProductState(productId=productId, objectId=clientId, actionRequest="none")

	@rpc_method(deprecated=True, alternative_method="productOnClient_updateObjects", check_acl=False)
	def getLocalBootProductStates_hash(
	...
	@rpc_method(deprecated=True, alternative_method="productOnClient_updateObjects", check_acl=False)
	def getNetBootProductStates_hash(
		self: BackendProtocol, objectIds: list[str] | None = None, options: dict | None = None
	) -> dict[str, list]:
	...
	def createProductPropertyDefinition(
		self: BackendProtocol,
		productId: str,
		name: str,
		description: str | None = None,
	...
	def getLicenseContractIds_list(self: BackendProtocol) -> list[str]:
	...
	def getLicenseContract_hash(self: BackendProtocol, licenseContractId: str) -> dict:
	...
	@rpc_method(deprecated=True, alternative_method="licenseContract_getObjects", check_acl=False)
	def getLicenseContracts_listOfHashes(self: BackendProtocol) -> list[dict]:
		license_contracts = []
	...
	def deleteLicenseContract(self: BackendProtocol, licenseContractId: str) -> None:
	...
	def getSoftwareLicenseIds_list(self: BackendProtocol) -> list[str]:
	...
	def getSoftwareLicense_hash(self: BackendProtocol, softwareLicenseId: str) -> dict:
	...
	@rpc_method(deprecated=True, alternative_method="softwareLicense_getObjects", check_acl=False)
	def getSoftwareLicenses_listOfHashes(self: BackendProtocol) -> list[dict]:
		software_licenses = []
	...
	def getLicensePoolIds_list(self: BackendProtocol) -> list[str]:
	...
	def getLicensePool_hash(self: BackendProtocol, licensePoolId: str) -> dict:
	...
	@rpc_method(deprecated=True, alternative_method="licensePool_getObjects", check_acl=False)
	def getLicensePools_listOfHashes(self: BackendProtocol) -> list[dict]:
		license_pools = []
	...
	def deleteLicensePool(self: BackendProtocol, licensePoolId: str, deleteLicenses: bool = False) -> None:
		if deleteLicenses:
	...
	@rpc_method(deprecated=True, alternative_method="licensePool_getIdents", check_acl=False)
	def getLicensePoolId(self: BackendProtocol, productId: str = "", windowsSoftwareId: str = "") -> str:
	...
	def getOrCreateSoftwareLicenseUsage_hash(
	...
	@rpc_method(deprecated=True, alternative_method="licenseOnClient_getOrCreateObject", check_acl=False)
	def getAndAssignSoftwareLicenseKey(
		self: BackendProtocol, hostId: str, licensePoolId: str = "", productId: str = "", windowsSoftwareId: str = ""
	) -> str:
		license_key = ""
		try:
	...
	@rpc_method(deprecated=True, alternative_method="licenseOnClient_getOrCreateObject", check_acl=False)
	def getLicenseKey(self: BackendProtocol, productId: str, clientId: str) -> str:
		"""
	...
	def getSoftwareLicenseUsages_listOfHashes(
	...
	def deleteAllSoftwareLicenseUsages(self: BackendProtocol, hostIds: list[str]) -> None:
	...
	def getLicenseStatistics_hash(self: BackendProtocol) -> dict[str, Any]:
		result = {}
		for license_pool in self.licensePool_getObjects():
	...
	def getMD5Sum(self: BackendProtocol, filename: str) -> str:
	...
	def librsyncSignature(self: BackendProtocol, filename: str) -> str:
	...
	def getDiskSpaceUsage(self: BackendProtocol, path: str) -> dict[str, float]:
	...
	def userIsAdmin(self: BackendProtocol) -> bool:
		if self.accessControl_userIsAdmin():
			return True
		raise BackendAuthenticationError("User is not an admin")

	@rpc_method(deprecated=True, alternative_method="productOnDepot_getIdents", check_acl=False)
	def areDepotsSynchronous(self: BackendProtocol, depotIds: list[str] | None = None) -> bool:
		depotIds = self.host_getIdents(type="OpsiDepotserver", id=depotIds, returnType="unicode")
		if not depotIds:
