...
class RPCHostMixin(Protocol):
	...
	def host_createOpsiDepotserver(
		...
		id: str,
		opsiHostKey: str | None = None,
		depotLocalUrl: str | None = "file:///var/lib/opsi/depot",
		depotRemoteUrl: str | None = None,
		depotWebdavUrl: str | None = None,
		repositoryLocalUrl: str | None = "file:///var/lib/opsi/repository",
		...
		workbenchLocalUrl: str | None = "file:///var/lib/opsi/workbench",
