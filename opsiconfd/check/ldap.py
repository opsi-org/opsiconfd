...
def check_ldap_connection(result: CheckResult) -> CheckResult:
...
ldap_connection_check = Check(
	id="ldap_connection",
	name="LDAP Connection",
	description="Checks whether opsi can connect to the configured LDAP server.",
	documentation=docs,
	message="LDAP authentication is not configured.",
	check_function=check_ldap_connection,
	cache=True,
	cache_expiration=3600,
)

CheckRegistry().register(ldap_connection_check)
