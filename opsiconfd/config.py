...
parser.add(
	...
	default="[%(opsilevel)s] [%(asctime)s.%(msecs)03d] %(message)s   (%(filename)s:%(lineno)d)",
...
parser.add(
	...
	default="%(log_color)s[%(opsilevel)s] [%(asctime)s.%(msecs)03d]%(reset)s [%(client_address)s] %(message)s   (%(filename)s:%(lineno)d)",
